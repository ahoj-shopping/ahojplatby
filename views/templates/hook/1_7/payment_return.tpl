...
{else}
    <p class="warning">
      ...
      {l s='Vaša objednávka bola zrušená, pretože platba bola zamietnutá. Môžete vytvoriť novú objednávku a vyberte si iný spôsob platby. Ďakujeme.' d='Modules.Ahojplatby.Shop'}
    </p>
{/if}
